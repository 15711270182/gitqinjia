...
class Base extends Controller
{
    ...
    public function initialize()
    {
        ...
        if($controller != 'Task' && $controller != 'Token' && $api != 'Index/getuserlist' && $api != 'Index/checktel' && $api != 'Index/checkcode' && $api != 'Index/getvideolist' && $api != 'Index/getvideoinfo' && $api != 'Index/shareinfo' && $api != 'Index/ques' && $api !='User/pushsubuser' && $api !='Index/sendtjmsg' && $api != 'Order/makeorderh5') { //不需要检测的接口
